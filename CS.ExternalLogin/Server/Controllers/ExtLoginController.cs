    ...
    public class ExtLoginController : Controller
    {
        ...
        public async Task<User> Login([FromBody] User user, bool setCookie, bool isPersistent)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (identityuser == null)
                {
                    //Check and create new user into application..
                    ...
                    if (checkLogin)
                    {
                        ...
                        await _identityUserManager.ConfirmEmailAsync(identityuser, token);
                    }
                }
